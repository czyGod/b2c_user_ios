...
#import "CheckIfBindMobileApi.h"

@implementation CheckIfBindMobileApi

- (void)checkIfBindMobileWithCallBack:(ApiRequestCallBack)callBack {

    HttpRequestTool * tool = [HttpRequestTool shareManage];
    
    [tool asynPostWithBaseUrl:nil apiMethod:@"artist.user.checkIfBindMobile" parameters:[self publicParameters] success:^(id responseObj) {
...
- (NSDictionary *)publicParameters
{
    ...
    params[@"api_name"] = @"artist.user.checkIfBindMobile";
